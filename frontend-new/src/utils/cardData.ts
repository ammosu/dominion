...
export const CARD_DATA: Record<string, CardData> = {
  ...
  Province: {
    ...
    type: 'victory',
    cost: 8,
    art: '/assets/cards/province.webp',
    vp: 6,
  ...
  Workshop: {
    ...
    type: 'action',
    cost: 3,
    art: '/assets/cards/workshop.webp',
  ...
  Woodcutter: {
    ...
    type: 'action',
    cost: 3,
    art: '/assets/cards/woodcutter.webp',
